...
def drawStroop(level):
    if level == "LowStress":
        ...
        message = visual.TextStim( mywin, text=f'1) {choices[0][0]} {choices[0][1]} {choices[0][2]}\n2) {choices[1][0]} {choices[1][1]} {choices[1][2]}\n3) {choices[2][0]} {choices[2][1]} {choices[2][2]}\n4) {choices[3][0]} {choices[3][1]} {choices[3][2]}', languageStyle='LTR')
        message.contrast =  0.3
        message.height = 0.13
        message.pos = (0, -0.1)
        message.draw() # draw on screen
        ...
        if (idx_word[0] != idx_color[0])and (idx_word[1] != idx_color[1]) and (idx_word[2] != idx_color[2]) and (idx_word[3] != idx_color[3]):
            ...
            message = visual.TextStim( mywin, text=f'1) {choices[0][0]} {choices[0][1]} {choices[0][2]} {choices[0][3]}\n2) {choices[1][0]} {choices[1][1]} {choices[1][2]} {choices[1][3]}\n3) {choices[2][0]} {choices[2][1]} {choices[2][2]} {choices[2][3]}\n4) {choices[3][0]} {choices[3][1]} {choices[3][2]} {choices[3][3]}', languageStyle='LTR')
            message.contrast =  0.3
            message.height = 0.13
            message.pos = (0, -0.1)
            message.draw() # draw on screen
